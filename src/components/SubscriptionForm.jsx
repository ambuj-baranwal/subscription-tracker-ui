...
const SubscriptionForm = ({ subscription }) => {
    ...
    const inputStyles = "w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white";
                    ...
                    <form.Field name="name">
                        {f => (
                            <div>
                                ...
                                <input className={inputStyles} placeholder="e.g. Netflix, Gym" value={f.state.value} onChange={e => f.handleChange(e.target.value)} />
                            </div>
                        )}
                    </form.Field>
                        ...
                        <form.Field name="price">
                            {f => (
                                <div className="md:col-span-2">
                                    ...
                                    <input type="number" className={inputStyles} placeholder="0.00" value={f.state.value} onChange={e => f.handleChange(+e.target.value)} />
                                </div>
                            )}
                        </form.Field>
                        ...
                        <form.Field name="currency">
                            {f => (
                                <div>
                                    ...
                                    <select className={inputStyles} value={f.state.value} onChange={e => f.handleChange(e.target.value)}>
                                        <option>INR</option><option>USD</option><option>EUR</option><option>JPY</option>
                                    </select>
                                </div>
                            )}
                        </form.Field>
                        ...
                        <form.Field name="paymentMethod">
                            {f => (
                                <div>
                                    ...
                                    <input className={inputStyles} placeholder="e.g. Credit Card ****" value={f.state.value} onChange={e => f.handleChange(e.target.value)} />
                                </div>
                            )}
                        </form.Field>
                            ...
                            {f => (
                                <div>
                                    ...
                                    <input type="datetime-local" className={inputStyles}
                                           ...
                                           onChange={e => f.handleChange(new Date(e.target.value).toISOString())} />
                                </div>
                            )}
                        </form.Field>
                    ...
                    <div className="pt-4 border-t border-gray-100">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button type="button"
                                    ...
                                    onClick={() => setReminders([...reminders, { type: "email", scheduleType: "monthly", payload: {} }])}>
                        ...
                        <div className="space-y-3">
                            {reminders.map((r, i) => (
                                <div key={i} className="flex gap-3 items-center bg-gray-50 p-3 rounded-lg border border-gray-200">
                                    ...
                                    <select className={`${inputStyles} py-1.5 text-sm flex-1`}
                                            value={r.scheduleType}
                                            onChange={e => {
                                                const x = [...reminders]; x[i].scheduleType = e.target.value; setReminders(x);
                                            }}>
                                        <option value="daily">Daily</option>
                                        <option value="weekly">Weekly</option>
                                        <option value="monthly">Monthly</option>
